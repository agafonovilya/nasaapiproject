...
class PictureOfTheDayFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val podServerResponseData = requireActivity().intent.getParcelableExtra<PodServerResponseData>("PodServerResponseData")
        podServerResponseData?.let { renderData(it) }
